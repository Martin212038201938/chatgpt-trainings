...
const UnsereAngebote = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Unsere Angebote – Prompt Engineering & KI-Workflow-Trainings | chatgpt-trainings.de"
        description="ChatGPT-Trainings in drei Stufen: Essentials für den Einstieg, Advanced Prompt Systems für Fortgeschrittene, KI-Workflow-Design für den produktiven Dauerbetrieb."
        keywords={[
          "ChatGPT Schulung",
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="text-center mb-12">
              ...
              <p className="mt-6 text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up-delayed">
                Drei Kompetenzstufen – vom ersten Prompt bis zum produktiven KI-Workflow-Design.
              </p>
            </div>
            ...
            <div className="mt-12 relative max-w-4xl mx-auto">
              ...
              <div className="relative bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border-2 border-primary/30 rounded-xl p-6 md:p-8 text-center">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
                  Stellen Sie Ihr Training aus einzelnen Modulen zusammen – exakt auf die Anforderungen Ihres Teams zugeschnitten.
                </p>
                <Link to="/training-konfigurator" className="inline-block">
              ...
              <Card className="border-2 border-violet-500/30 bg-gradient-to-br from-violet-500/5 to-purple-500/5">
                ...
                <CardDescription className="px-6 pb-6 text-center">
                  <p className="mb-3">
                    ...
                    Nach bestandener Prüfung erhalten Teilnehmer und Unternehmen ein offizielles <strong>Zertifikat</strong>.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Aufbauende Stufen: <strong>Essentials → Advanced → Pro → Expert</strong>
                  </p>
                </CardDescription>
              </Card>
            </div>
