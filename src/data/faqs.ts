...
export const homepageFAQs: FAQ[] = [
  ...
  {
    question: "Für wen sind die Copilot-Trainings der chatgpt-trainings.de geeignet?",
  ...
  {
    question: "Wie unterstützt chatgpt-trainings.de bei einem Copilot-Rollout im Unternehmen?",
  ...
  {
    question: "Wie kann ich ein Copilot-Training bei chatgpt-trainings.de anfragen?",
  ...
  {
    question: "Bietet chatgpt-trainings.de auch Prüfungen und Zertifikate für Copilot-Trainings an?",
...
export const githubCopilotFAQs: FAQ[] = [
  ...
  {
    question: "Für wen eignet sich das GitHub Copilot Training der chatgpt-trainings.de?",
