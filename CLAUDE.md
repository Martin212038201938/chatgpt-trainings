...
---
## Projekt: ChatGPT-Trainings.de

- **Repository:** Martin212038201938/chatgpt-trainings
- **Live-URL:** https://chatgpt-trainings.de
- **Tech Stack:** Vite + React + TypeScript + Tailwind CSS + shadcn/ui
- **Deployment:** Push zu `main` → GitHub Actions → FTP zu alwaysdata.com
- **Template-Quelle:** Geklont von copilotenschule.de (team-copilot-collective)

### Lokale Entwicklung
```bash
cd ~/Documents/Cowork\ Bereich/chatgpt-trainings
npm install
npm run dev
```
